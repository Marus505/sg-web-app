 ...
 *
 */
public class ControllerTestBuilder implements JavaSourceBuilder, SourceBuilder {

	/**
	 * Template 파일 (tpl)
	 */
	public static final String TEMPLATE = "/static/tpl/ControllerTestTemplate.template";
	...
	public void build(SourceBuilderProperties<String, Object> properties) throws Exception {
		...
		String importArea = createImportAreaSource(importDefine, svcPackage, svcClass, businessPackage, businessClass, domainPackage, domainClass);

		String getListMethod = createCommonMethodSource(getListMethodDefine, svcPackage, svcClass, domainPackage, businessKoreanName, businessEnglishName, businessPackage, businessClass, domainClass, svcClass, controllerMapName, jspPrefix, javaKeyFields, javaKeyTypes);

		String getMethod = createCommonMethodSource(getMethodDefine, svcPackage, svcClass, domainPackage, businessKoreanName, businessEnglishName, businessPackage, businessClass, domainClass, svcClass, controllerMapName, jspPrefix, javaKeyFields, javaKeyTypes);

		String insertViewMethod = createCommonMethodSource(insertViewMethodDefine, svcPackage, svcClass, domainPackage, businessKoreanName, businessEnglishName, businessPackage, businessClass, domainClass, controllerMapName, jspPrefix, svcClass, javaKeyFields, javaKeyTypes);

		String insertMethod = createCommonMethodSource(insertMethodDefine, svcPackage, svcClass, domainPackage, businessKoreanName, businessEnglishName, businessPackage, businessClass, domainClass, svcClass, controllerMapName, jspPrefix, javaKeyFields, javaKeyTypes);

		String updateViewMethod = createCommonMethodSource(updateViewMethodDefine, svcPackage, svcClass, domainPackage, businessKoreanName, businessEnglishName, businessPackage, businessClass, domainClass, svcClass, controllerMapName, jspPrefix, javaKeyFields, javaKeyTypes);

		String updateMethod = createCommonMethodSource(updateMethodDefine, svcPackage, svcClass, domainPackage, businessKoreanName, businessEnglishName, businessPackage, businessClass, domainClass, svcClass, controllerMapName, jspPrefix, javaKeyFields, javaKeyTypes);

		String deleteMethod = createCommonMethodSource(deleteMethodDefine, svcPackage, svcClass, domainPackage, businessKoreanName, businessEnglishName, businessPackage, businessClass, domainClass, svcClass, controllerMapName, jspPrefix, javaKeyFields, javaKeyTypes);
	 ...
	 * @return String
	 */
	private String createImportAreaSource(final String importDefine, String businessSvcPackage, String businessSvcClass, String businessPackage, String businessClass, String domainPackage, String domainClass){
...
//		importStrings += "import " + businessPackage + "." + businessClass + ";";
	 ...
	 * @return String
	 */
	private String createCommonMethodSource(final String getDefine, String packageName, String className, String domainPackage, String businessKoreanName, String businessEnglishName, String businessPackage, String businessClass, String domainClass, String svcClass, String controllerMapName, String jspPrefix, String[] javaKeyFields, String[] javaKeyTypes){
		...
		source = SourceBuilderUtil.replaceVariables(source, BUSINESS_CLASS, businessClass);
		source = SourceBuilderUtil.replaceVariables(source, BUSINESS_FIELD, Utility.toFieldName(businessClass));
		source = SourceBuilderUtil.replaceVariables(source, DOMAIN_PACKAGE, domainPackage);
